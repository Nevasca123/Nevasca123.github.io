...
Carousel.DEFAULTS={interval:5000,stransition:600,pause:'hover',wrap:true,keyboard:true}
...
$(document).on('click.bs.carousel.data-api','[data-slide]',clickHandler).on('click.bs.carousel.data-api','[data-slide-to]',clickHandler)}(jQuery);jQuery(document).ready(function(){jQuery(".cryout-serious-slider").swiperight(function(){jQuery(".cryout-serious-slider").carousel('prev');});jQuery(".cryout-serious-slider").swipeleft(function(){jQuery(".cryout-serious-slider").carousel('next');});});